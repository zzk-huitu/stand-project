...
Ext.define("core.system.user.controller.OtherController", {
    ...
    control:{    
        ...
        //选择班主任，界面加载事件
        "window[funcPanel=system.user.selectuserlayout]":{
            afterrender:function(win){
                ...
                var grid = win.down("grid[xtype=system.user.isselectusergrid]");
                var store = grid.getStore();
                var proxy = store.getProxy();
                proxy.extraParams = {
                	uuid: classId
        ...
        //选择班主任，勾选后提交事件
        "window[funcPanel=system.user.selectuserlayout] button[ref=ssOkBtn]":{
            beforeclick: function(btn) {
                
                var win=btn.up("window[funcPanel=system.user.selectuserlayout]");
                var grid=win.down("grid[xtype=system.user.isselectusergrid]");
